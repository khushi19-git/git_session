...
class jmb23282 {
    ...
    public static void main(String[] args) {
        ...
        while (ordering) {
            ...
            if (mainChoice == 1) { // Thali
                ...
                System.out.print(YELLOW + "Do you want to confirm this Thali? (1 = Yes, 0 = No): " + RESET);
                ...
                switch (bch) {
                    case 1: breakfastItem = "Poha + Jalebi + Tea/Coffee"; breakfastPrice = 200; break;
                    case 2: breakfastItem = "Bread + Heavy Snacks + Tea/Coffee"; breakfastPrice = 250; break;
                    case 3: breakfastItem = "Heavy Snacks + Tea/Coffee"; breakfastPrice = 320; break;
                }
    ...
    public static void showThaliItems(String thaliName) {
        ...
        System.out.println("- Soup/Drink");
        System.out.println("- Paneer Dish");
        System.out.println("- Two Veg Dishes");
        System.out.println("- Dal");
        if (thaliName.equals("Thali 5") || thaliName.equals("Thali 6")) {
            System.out.println("- Starter");
            System.out.println("- Curd Dish");
        }
    ...
    public static String chooseDal(Scanner sc) {
        ...
        System.out.println(YELLOW + "1. Tadka Dal\n2. Dal Makhani\n3. Panchmel Dal\n4. Moong Dal" + RESET);
    ...
    public static String chooseRice(Scanner sc) {
        ...
        System.out.println(PITCH_BG + BLACK + "1." + RESET);
        int ch = getIntInRange(sc, "Enter choice (1-4): ", 1, 4);
        switch (ch) {
            case 1: 
            return "Steamed Rice";
    ...
    public static String[] chooseDessert(Scanner sc) {
        System.out.println(BLUE + "Choose Dessert Type:" + RESET);
        ...
        System.out.println(BLUE + "Choose Variant:" + RESET);
        String variant = "";
        switch (type) {
            case 1:
...
public static String chooseChinese(Scanner sc) {
        System.out.println(WHITE + MAROON_BG + "Choose Chinese and Continental :" + RESET);
                            System.out.println(BLACK + PITCH_BG + "1. Backed Veg  " + RESET);
    ...
    public static String chooseCurd(Scanner sc) {
        System.out.println(BLUE + "Choose Curd:" + RESET);
        System.out.println(YELLOW + "1. Plain Curd\n2. Sweet Curd\n3. Masala Curd" + RESET);
        int ch = getIntInRange(sc, "Enter choice (1-3): ", 1, 7);
        switch (ch) {
                 case 1:
                 return "Veg Raita";
                 case 2:
